...
object ICP6 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Saving to File
    stationGraph.vertices.write.csv("C:\\Users\\bhava\\Downloads\\Spark_ICP_5\\Graph1\\Vertices")
    stationGraph.edges.write.csv("C:\\Users\\bhava\\Downloads\\Spark_ICP_5\\Graph1\\Edges")
