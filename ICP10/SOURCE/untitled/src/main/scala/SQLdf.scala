...
object SQLdf {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("C:\\Users\\bhava\\IdeaProjects\\untitled\\survey.csv")


    //df.show()

    df.write.format("csv").option("header","true").save("C:\\Users\\bhava\\IdeaProjects\\untitled\\output3")
    ...
    val lines = sc.textFile("C:\\Users\\bhava\\IdeaProjects\\untitled\\survey.csv")
